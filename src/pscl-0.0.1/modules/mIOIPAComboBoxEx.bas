Attribute VB_Name = "mIOIPAComboBoxEx"
'========================================================================================
' FileName:    mIOIPAComboboxEx.bas (mIOleInPlaceActivate.bas)
...
Public Type IPAOHookStructComboBoxEx
    lpVTable    As Long                    'VTable pointer
    IPAOReal    As IOleInPlaceActiveObject 'Un-AddRefed pointer for forwarding calls
    ctl         As ucComboBoxEx         'Un-AddRefed native class pointer for making Friend calls
    ThisPointer As Long
End Type
...
Public Sub InitIPAO(IPAOHookStruct As IPAOHookStructComboBoxEx, ctl As ucComboBoxEx)
...
Public Sub TerminateIPAO(IPAOHookStruct As IPAOHookStructComboBoxEx)
...
Private Function AddRef(This As IPAOHookStructComboBoxEx) As Long

    AddRef = This.IPAOReal.AddRef

End Function

Private Function Release(This As IPAOHookStructComboBoxEx) As Long

    Release = This.IPAOReal.Release

End Function

Private Function QueryInterface(This As IPAOHookStructComboBoxEx, riid As GUID, pvObj As Long) As Long
...
Private Function GetWindow(This As IPAOHookStructComboBoxEx, phwnd As Long) As Long

    GetWindow = This.IPAOReal.GetWindow(phwnd)

End Function

Private Function ContextSensitiveHelp(This As IPAOHookStructComboBoxEx, ByVal fEnterMode As Long) As Long

    ContextSensitiveHelp = This.IPAOReal.ContextSensitiveHelp(fEnterMode)

End Function

Private Function TranslateAccelerator(This As IPAOHookStructComboBoxEx, lpMsg As MSG) As Long
...
Private Function OnFrameWindowActivate(This As IPAOHookStructComboBoxEx, ByVal fActivate As Long) As Long

    OnFrameWindowActivate = This.IPAOReal.OnFrameWindowActivate(fActivate)

End Function

Private Function OnDocWindowActivate(This As IPAOHookStructComboBoxEx, ByVal fActivate As Long) As Long

    OnDocWindowActivate = This.IPAOReal.OnDocWindowActivate(fActivate)

End Function

Private Function ResizeBorder(This As IPAOHookStructComboBoxEx, prcBorder As RECT, ByVal puiWindow As IOleInPlaceUIWindow, ByVal fFrameWindow As Long) As Long

    ResizeBorder = This.IPAOReal.ResizeBorder(VarPtr(prcBorder), puiWindow, fFrameWindow)

End Function

Private Function EnableModeless(This As IPAOHookStructComboBoxEx, ByVal fEnable As Long) As Long
